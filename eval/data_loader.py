...
def load_data(data_name, split, data_dir="./data"):
    ...
    if data_name == "gpqa":
        data_file = f"{data_dir}/{data_name}/gpqa.json"
    elif data_name == "mmlu":
        data_file = f"{data_dir}/{data_name}/mmlu.json"
    elif data_name == "arc":
        data_file = f"{data_dir}/{data_name}/arc.json"
    elif data_name == "stg":
        data_file = f"{data_dir}/{data_name}/stg.json"
    if os.path.exists(data_file):
        ...
        elif data_name in ["gpqa", "arc", "mmlu", "stg"]:
