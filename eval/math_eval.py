...
def setup(args):
    ...
    print(f"model: {args.model_name_or_path} | prompt_type: {args.prompt_type} | out_file: {args.output_dir}")
    ...
    if args.apply_chat_template:
        input_prompts = [
            tokenizer.apply_chat_template(
                [
                    {"role": "system", "content": "A conversation between User and Assistant. The user asks a question, and the Assistant solves it step by step. The assistant first thinks about the reasoning process in the mind and then provides the user with the answer, i.e., reasoning process here ... the answer is \\boxed{answer}\n\n"},
